...
SECRET_KEY = os.getenv(
    "SECRET_KEY", "django-insecure-0g-_-4&t(n-v6p#g(e(%45(ks282z7(20*s*f^o-&xmzz&62h="
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "marketplace.context_processors.unread_messages_context",
...
if os.getenv("CLOUDINARY_CLOUD_NAME"):
    ...
    # Production but without Cloudinary configured yet (fallback to local server storage)
    STORAGES = {
        "default": {
...
if RESEND_API_KEY and (not DEFAULT_FROM_EMAIL or "gmail.com" in DEFAULT_FROM_EMAIL.lower() or "googlemail.com" in DEFAULT_FROM_EMAIL.lower()):
    DEFAULT_FROM_EMAIL = "onboarding@resend.dev"
elif not DEFAULT_FROM_EMAIL:
    DEFAULT_FROM_EMAIL = os.getenv("EMAIL_HOST_USER", "ceasermakpwe@gmail.com")
